...
class FieldDelegate(NSObject):
    def controlTextDidChange_(self, notification):
        self.component.on_text_updated(notification)

class CocoaField(CocoaControl, AbstractTkField):
    """ A Cocoa implementation of a Field.

    CocoaField uses a NSTextField to provides a single line of editable text.
    ...
    def initialize(self):
        """ Initializes the attributes of the Cocoa widget.

        """
        super(CocoaField, self).initialize()
    ...
    def on_max_length(self, event):
        ...
        """
        print 'max length not implemented'
    ...
    def set_max_length(self, max_length):
        ...
        """
        print 'set_max_length not implemented'
    ...
    def set_read_only(self, read_only):
        ...
        """
        print 'set read only', read_only
        self.widget.setEditable_(not read_only)

    def set_placeholder_text(self, placeholder_text):
        """ Sets the placeholder text in the widget.

        """
        print 'set_placeholder_text not implemented'
    ...
    def set_cursor_position(self, cursor_position):
        ...
        """
        print 'set_cursor_position not implemented'
