...
def cocoa_toolkit():
    ...
    toolkit = Toolkit(COCOA_CONSTRUCTORS)
    
    toolkit.create_app = get_app_cocoa
    toolkit.start_app = start_event_loop_cocoa
    toolkit.style_sheet = COCOA_STYLE_SHEET
    toolkit.update(utils)
    toolkit.update(OPERATORS)
